...
The numbers are delta numbers, not positions: 5 is claimed by the forge seal,
specified on its own branch, so the grain has a gap and the roadmap's
D-numbers and these agree.
